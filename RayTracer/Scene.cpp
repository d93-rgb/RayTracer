...
void Scene::init()
{
	...
	std::vector<std::shared_ptr<Material>> mats = {
		...
		std::shared_ptr<Material>(new Material(glm::vec3(0.1, 0.1, 0.1), glm::vec3(0.0, 0.0, 0.0), glm::vec3(0, 0, 0))),
		std::shared_ptr<Material>(new Material(glm::vec3(0.1, 0.1, 0.1), glm::vec3(0.0, 0.0, 0.0), glm::vec3(0, 0, 0)))
	...
	std::shared_ptr<Material> wall_right =
		std::shared_ptr<Material>(new Material(glm::vec3(0.3, 0.3, 0.3), glm::vec3(0.2, 0.8, 0.4), glm::vec3(0, 0, 0)));
	std::shared_ptr<Material> wall_left =
		std::shared_ptr<Material>(new Material(glm::vec3(0.1, 0.1, 0.1), glm::vec3(0.2, 0.8, 0.4), glm::vec3(0, 0, 0)));
